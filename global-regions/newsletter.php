...
$newsletter->add_element("Code", array (
  ...
  array (
    ...
    <input type="email" name="user-email" placeholder="EE-Mail-Adresse eingeben, für exklusive Neuigkeiten">
...
$newsletter->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h3 class="" style="text-align: center;"><span class="upfront_theme_color_3" data-verified="redactor" data-redactor-tag="span" data-redactor-class="upfront_theme_color_3"><span class="upfront_theme_color_3">Hole Deine App</span></span></h3>',
    'type' => 'PlainTxtModel',
